...
8. **Deploy to Vercel** (recommended)
   ...
   - Add environment variables in Project Settings: `DATABASE_URL`, `NEXTAUTH_SECRET`, and any API keys.
   - Vercel will run `npm run build` automatically on push — check the build logs if failures occur.
