...
async function seedDatabase() {
  ...
  try {
    ...
    if (existingProjectCount > 0 && existingSkillCount > 0 && existingEducationCount > 0 && existingBlogCount > 0) {
    ...
    // Testimonials removed: no seeding performed
    ...
    // Testimonials removed: no listing
